...
class TestArbolDOM(unittest.TestCase):
    ...
    def test_crea_arbol(self):
        ...
        NodoRaiz = NodoControlModel(ControlModel(1,1,'Pantalla','Pantalla1','Pantalla.template',False, True))
    ...
    def test_find_nodoRaizNombre(self):
        ...
        """
        # Creamos el control que es el NodoRaiz
        NodoRaiz = NodoControlModel(ControlModel(1,1,'Pantalla','PantallaPrueba','Pantalla.template',False, True))
        ArbolTmp = ArbolDom(NodoRaiz)
    ...
    def test_agregaNodoHijo(self):
        ...
        NodoHijo = NodoControlModel(ControlModel(2,2,'Boton','Boton1','Boton.template',False,False))
    ...
    def test_findNodoHijo(self):
        ...
        NodoRaiz = NodoControlModel(ControlModel(1,1,'Pantalla','PantallaPrueba','Pantalla.template',False,True))
        # Creamos el control que será el nodo hijo de nodo raiz
        NodoHijo = NodoControlModel(ControlModel(2,2,'Lista','Lista1','Lista.template',False,False))
        NodoHijo2 = NodoControlModel(ControlModel(3,3,'Boton','Boton1','Boton.template',True,False))
        # Creamos el control que será el nodo hijo de nodo raiz
        NodoHijo3 = NodoControlModel(ControlModel(4,4,'Lista','Lista2','Lista.template',False,False))
        NodoHijo4 = NodoControlModel(ControlModel(5,5,'Boton','Boton2','Boton.template',True,False))
        # Creamos el árbol con un NodoRaiz
        ArbolTmp = ArbolDom(NodoRaiz)
        # Se agrega el control hijo
        ArbolTmp.agregaControlHijo(1,NodoHijo)
